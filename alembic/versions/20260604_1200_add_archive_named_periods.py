...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.ForeignKey("archive_named_periods.id", ondelete="CASCADE"),
            nullable=False,
        ),
    ...
    op.create_index(
        "archive_named_periods_kind_status_sort_idx",
        "archive_named_periods",
        ["kind", "status", "sort_order"],
        unique=False,
    )
    op.create_index(
        "archive_named_periods_date_range_idx", "archive_named_periods", ["date_from", "date_to"], unique=False
    )
    ...
    op.create_index(
        "archive_named_period_stats_period_id_idx", "archive_named_period_stats", ["period_id"], unique=False
    )
