...
def test_short_asr_fragments_do_not_get_periods_inside_paragraphs():
    segments = [
        ...
        TranscriptSegment(
            start_ms=1020, end_ms=1500, text="misinformation and conspiracy theories", speaker_label=None
        ),
        TranscriptSegment(
            start_ms=1520, end_ms=2000, text="is flourishing with the rise of online", speaker_label=None
        ),
        TranscriptSegment(
            start_ms=2020, end_ms=2500, text="social platforms that cater to extremist", speaker_label=None
        ),
